...
public class IsNotAttributeApplierTest {
    ...
    public void testCreate() {
        ...
        new IsNotAttributeApplier(applier);
    }

    @Test(expected = AssertionError.class)
    public void testCreateWithNullColour() {

        new IsNotAttributeApplier(null);
    }
    ...
    public void testApplyWithNoRule() {
        ...
        new IsNotAttributeApplier(applier).apply(context, null, TEST_STRING);
    ...
    public void testApplyWithNullRuleContext() {
        ...
        new IsNotAttributeApplier(applier).apply(null, null, TEST_STRING);
    }
}
